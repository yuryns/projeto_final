...
/* Adicionar sombra na nav quando der scroll */
...
/* Efeito de animação para a info box */
const infoBox = document.querySelector('.info-box');

function animateInfoBox() {
  if (window.scrollY > 100) { // ajuste a posição de scroll conforme necessário
    infoBox.classList.add('start');
  } else {
    infoBox.classList.remove('start');
  }
}
...
window.addEventListener('scroll', function () {
  ...
  button();
  menuActive();
  animateInfoBox(); // Adicionada a chamada para animar a info box
});
